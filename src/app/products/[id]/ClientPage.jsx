...
export default function ClientPage({ id, products, brands, categories }) {
  ...
  useEffect(() => {
    ...
    setBrand(brands.find((b) => b.id === foundProduct.brand) || null);
    setCategory(
      categories.find((c) => c.id === foundProduct.category) || null
    );
  ...
  /* ⬇️ JSX remains SAME as your original page ⬇️ */
 return (
